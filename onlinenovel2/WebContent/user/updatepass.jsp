...
<body>
<div class="container">
<form name="form1"  class="form-signin" method="post" action="${pageContext.request.contextPath}/user/updatepass" onsubmit="return check()">
...
<input type="hidden"  name="action" value="updatePass">
 <button class="btn btn-lg btn-primary btn-block"  data-loading-text="更新中....." type="submit">更新</button>
