<%@page import="com.ly.novel.entity.Novel"%>
...
<center>
<c:if test="${null!=categoryname}">
<span style="text-align: left">${categoryname}</span>
</c:if>
<table  class="table table-hover  table-condensed">
 ...
 <tbody>
  ...
  <c:otherwise>
  <tr>
  	<td colspan="5"  style="text-align: left">目前还没有此类作品信息</td>
  </tr>
  </c:otherwise>
  </c:choose>
 </tbody>
