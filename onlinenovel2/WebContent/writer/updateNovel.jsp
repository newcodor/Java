...
<br>
<form action="${pageContext.request.contextPath}/novel/update" method="post" onsubmit="return checkApplyInfo()">
  <table class="table" >
  <tbody>
   <tr>
   		<td>书名</td>
...
<option value="6"  >都市言情</option>
  ...
  <input type="hidden" name="fromPage" value="writer/updateNovel">
</form>
</div>
</center>
</html>